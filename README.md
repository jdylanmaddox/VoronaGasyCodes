...
[instructions]([url](https://help.geneious.com/hc/en-us/articles/360044627372-How-can-I-BLAST-against-my-own-sequences-or-a-database-that-isn-t-part-of-NCBI)). For the Add BLAST Database step, simply select the VoronaGasyCodes file you importaned.
